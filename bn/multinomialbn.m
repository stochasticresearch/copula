            ...
            for mm=1:M
                ...
                for node=1:obj.D
                    ...
                    if(isa(nodeBnParam, 'rvEmpiricalInfo'))
                        ...
                        parentNodes = obj.getParents(node);
                        parentDataPoints = zeros(1,length(parentNodes));
                        parentDataPointsIdx = 1;
                        for parentNode=parentNodes
                            dataPoint = X_discretized_ll(mm,parentNode);
                            parentDataPoints(parentDataPointsIdx) = dataPoint;
                            parentDataPointsIdx = parentDataPointsIdx + 1;
                        end
