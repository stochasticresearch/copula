...
for h=0.1:0.1:1
    ...
    mse_smooth = mean((Rc_expect-Rc_c_emp_smooth).^2);
    mse_p9 = mean((Rc_expect-Rc_c_dens_kde_p9).^2);
    mse_p14 = mean((Rc_expect-Rc_c_dens_kde_p14).^2);
    mse_betak = mean((Rc_expect-Rc_c_dens_betak).^2);

    fprintf('Kernel BW=%f MSE_SMOOTH=%f MSE_P9=%f MSE_P14=%f MSE_BETAK=%f\n', ...
        h, mse_smooth, mse_p9, mse_p14, mse_betak);
end