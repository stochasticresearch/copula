...
%                         dispstat(sprintf('Monte-Carlo -- %0.02f', progressIdx/numLoopsPerDep*100),'timestamp');
                    ...
                    metricVec(ii) = rsdm_1(x,y, minscanincr, diffthresh, alpha);
...
if(ispc)
    save(sprintf('C:\\Users\\Kiran\\ownCloud\\PhD\\sim_results\\independence\\rsdm1_optimal_params_cfg%d.mat',cfg));
elseif(ismac)
    save(sprintf('/Users/Kiran/ownCloud/PhD/sim_results/independence/rsdm1_optimal_params_cfg%d.mat',cfg));
else
    save(sprintf('/home/kiran/ownCloud/PhD/sim_results/independence/rsdm1_optimal_params_cfg%d.mat',cfg));
end
