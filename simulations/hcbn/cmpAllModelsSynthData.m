...
global MULTINOMIAL_LL_MAT_IDX NUM_DISCRETE_INTERVALS
...
%                             empcopulaval(C_actual_discrete_integrate, uu1,1/K) - empcopulaval(C_actual_discrete_integrate, uu2,1/K)
                ...
                progressStr = sprintf('MEAN{refLL}=%f MEAN{hcbnLL}=%f MEAN{mteLL}=%f MEAN{clgLL}=%f MEAN{multinomialLL}=%f', ...
                ...
                progressStr = sprintf('VAR{refLL}=%f VAR{hcbnLL}=%f VAR{mteLL}=%f VAR{clgLL}=%f VAR{multinomialLL}=%f\n', ...
                ...
                llMat(copulaTypeVecIdx, ...
                        ...
                        alphaVecIdx, ...
                        mVecIdx, ...
                        MULTINOMIAL_LL_MAT_IDX) = meanLLDivMCMat(MULTINOMIAL_LL_MAT_IDX);
                llMat(copulaTypeVecIdx, ...
                         continuousDistTypeVecIdx,...
                         alphaVecIdx,...
                         mVecIdx,...
                         REF_LL_MAT_IDX) = meanLLDivMCMat(REF_LL_MAT_IDX);
                ...
                llVarMat(copulaTypeVecIdx, ...
                         ...
                         alphaVecIdx,...
                         mVecIdx,...
                         MULTINOMIAL_LL_MAT_IDX) = varLLDivMCMat(MULTINOMIAL_LL_MAT_IDX);
                llVarMat(copulaTypeVecIdx, ...
                         continuousDistTypeVecIdx,...
                         alphaVecIdx,...
                         mVecIdx,...
...
for copulaTypeVecIdx=1:length(copulaTypeVec)
    ...
    % % %                                 fX3_hcbn = hcbnObj.empInfo{3}.pdf(xiContinuous_val);
                    ...
                    progressStr = sprintf('refLL=%f hcbnLL=%f mteLL=%f clgLL=%f multinomialLL=%f\n', ...
                        refLL, hcbnLL, mteLL, clgLL, multinomialLL);
                    dispstat(progressStr,'keepthis','timestamp');
                ...
                llVarMat(copulaTypeVecIdx, ...
                         ...
                         alphaVecIdx,...
                         mVecIdx,...
                         REF_LL_MAT_IDX) = varLLDivMCMat(REF_LL_MAT_IDX);
            end
        end
    end
end
